    ...
    return (
        <div className="bg-white top-24 relative dark:bg-[#212121] shadow-md rounded-xl max-w-xl lg:mx-auto mx-4 lg:max-w-xl max-2xl md:mx-auto sm:mx-auto lg:px-0 ">
            <div className=" lg:p-6 p-2 max-md:p-5 ">
                <div className="px-4">
                    <div>
                        <h1 className="text-xl font-InterBo my-5">Personal Portfolio v2.0</h1>
                        ...
                        <div>
                            <Link href={"https://github.com/fiqihtri/Personal-Portfolio-v2.0.git"} className="flex gap-x-1 items-center my-5">
